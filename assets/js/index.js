...
function initCheckTheme() {
   ...
   function checkThemeSection() {
      ...
      for (var i = 0; i < themeSections.length; i++) {
         ...
         var themeObserverOffset = $(".main-nav-bar .nav-bar-scrolled-height").innerHeight();
         var themeObserverOffsetCenter = window.innerHeight / 2;
         ...
         if (themeSectionTop <= themeObserverOffsetCenter && themeSectionBottom >= themeObserverOffsetCenter) {
